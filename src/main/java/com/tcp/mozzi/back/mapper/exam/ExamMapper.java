...
public interface ExamMapper {
    ...
    List<Exam> getExamByYearOrNameOrProfessor(@Param("year") String year, @Param("name") String name, @Param("professor") String professor, @Param("page") int page, @Param("limit") int limit);
